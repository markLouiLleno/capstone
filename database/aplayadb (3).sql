...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2024 at 10:11 AM
...
(28, 'asd', 'asd', 'a@gmail.com', 'weee'),
(29, 'asd', 'asd', 'qweqwe@Hicut.com', '                '),
(30, '', '', '', '                '),
...
(20, 94, 'NIGHT TOUR', '70000', 1222, 122, 'rooms/1728317210_DSC_0213.JPG');
...
(1, 'Welcome to JPAMS Private Resort, a hidden gem where simplicity meets modern comfort. Experience the perfect blend of simplicity and sophistication with our cozy accommodations and top-notch security. Discover a sanctuary where nature’s beauty and modern amenities harmonize seamlessly.								', 'About Us'),
(2, 'Our vision at JPAMS Private Resort is to become a premier destination for intimate getaways, known for our exceptional service, serene environment, and personalized guest experiences. .', 'Vision'),
(3, 'Our mission is to create a peaceful and intimate retreat where guests can escape the hustle of everyday life', 'Mission');
...
(5, 'admin jpams', 'janu@yahoo.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Administrator'),
...
INSERT INTO `users` (`id`, `user_type`, `google_id`, `first_name`, `last_name`, `email`, `password`, `avatar`, `created_at`, `bio`) VALUES
(1, 'admin', '106700202670479176621', 'mark loui', '`lleno', 'lleno.markloui@gmail.com', '', 'https://lh3.googleusercontent.com/a/ACg8ocJJaOcFIO4nMT6AlgAUnaZOLroYO6CC1mZ0c7StyVMy4zI79Q=s96-c', '2024-10-09 15:29:22', NULL),
(2, 'customer', '105339567338913477272', 'mark loui', 'lleno', 'markayosky@gmail.com', '', 'https://lh3.googleusercontent.com/a/ACg8ocK2HEC4T46gV1FwOE4GDEjucU-B_A1-l36e6PHMqQTYyJF5zA=s96-c', '2024-10-10 15:09:42', NULL);
...
CREATE TABLE `usersp` (
  ...
  `profile_picture` varchar(255) DEFAULT 'img/user.jpg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usersp` (`id`, `name`, `email`, `bio`, `created_at`, `profile_picture`) VALUES
(1, 'frnz', 'frnz@gmail.com', 'asdwa', '2024-10-09 11:52:07', 'img/johndoe.jpg'),
(2, 'Jane Doe', 'janedoe@example.com', 'Bio for Jane', '2024-10-09 11:52:07', 'img/janedoe.jpg');
...
--
ALTER TABLE `room`
  MODIFY `roomNo` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `roomtype`
--
ALTER TABLE `roomtype`
  MODIFY `typeID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
